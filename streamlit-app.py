...
def initialize_vector_db():
    ...
    dataset_path = 'banking.txt'
    
    # Check if file exists to prevent crashing
    if not os.path.exists(dataset_path):
        # Creating a fallback file for demonstration if it doesn't exist
        with open(dataset_path, 'w') as f:
            f.write("Banking is the business of accepting deposits and lending money.\n")
            f.write("A bank provides financial services to individuals and businesses.\n")
            f.write("The Reserve Bank of India (RBI) is India's central bank.\n")
            f.write("RBI regulates banks in India.\n")
            f.write("A savings account is designed for personal savings.\n")
            f.write("A current account is designed for businesses and frequent transactions.\n")
...
# User Input
input_query = st.text_input("Ask me a question about banks:", placeholder="e.g., What is the history of the bank?")
